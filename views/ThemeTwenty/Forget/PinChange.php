  ...
  <div class="content content-last">
    <div class="content-bg">
      <div class="content-bg-bottom">
        <h2 class="pre-social"><?=langWrite('lang173')?></h2>
            ...
            <table class="table table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input class="form-control" type="password" placeholder="<?=langWrite('lang91')?>" name="pinPasswordTwo" minlength="<?=pinSifre['min']?>" maxlength="<?=pinSifre['max']?>" required>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
