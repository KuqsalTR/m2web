        ...
        <ul id="subnavi" class="nav nav-tabs">
          <?php foreach ($categories as $key => $value): ?>
            <li class="has-subnavi" >
              <a class="btn-catitem <?=(isset($category) && (($value->categoryId==$category->categoryId) || ($value->categoryId==$category->categoryUpperId))?'btn-catitem-active':false)?>" href="<?=base_url()?>Market/CategoryEM/<?=$value->categorySeo?>/<?=$value->categoryId?>">
              ...
              <?php if ($subCategories): ?>
                <ul class="dropdown-menu">
                  <?php foreach ($subCategories as $key => $value): ?>
                    <li class="has-subnavi">
                      <a class="btn-subcatitem" href="<?=base_url()?>Market/CategoryEM/<?=$value->categorySeo?>/<?=$value->categoryId?>"><?=$value->categoryName?></a>
                    </li>
                  <?php endforeach; ?>
                </ul>
              <?php endif; ?>
