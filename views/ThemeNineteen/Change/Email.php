        ...
        <div class="inner-form-border">
          <div class="inner-form-box" style="padding:25px!important">
            ...
            <form id="ChangeEmail" class="registerForm">
              ...
              <input id="submitBtn" type="submit" value="<?=langWrite('lang208')?>" class="btn-big">
            </form>
          </div>
        </div>
      </div>
